...
function isSelector(x: any): x is string {
...
function cloneTemplate<T extends HTMLElement>(
 ...
 */
function setElementData<T extends Record<string, unknown> | object>(
	el: HTMLElement,
	data: T
) {
 ...
 */
function getElementData<T extends Record<string, unknown>>(
	el: HTMLElement,
